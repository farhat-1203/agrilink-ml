"""
api/app.py  ─  FastAPI Application for Crop Quality Estimator

Endpoints:
    POST /analyze          — accepts base64 image in JSON body
    POST /analyze-upload   — accepts multipart file upload (mobile-friendly)
...
async def analyze_upload(
    ...
    Ideal for mobile clients (React Native, Flutter) using FormData.
...
if __name__ == "__main__":
    ...
    uvicorn.run(
        ...
        reload  = False,
        workers = 1,       # keep at 1 for the model singleton to work correctly
    )
